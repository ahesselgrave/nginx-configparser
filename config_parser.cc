...
bool NginxConfigParser::Parse(std::istream* config_file, NginxConfig* config) {
    ...
    /*
        Use stack to help with balancing scope.
        We can push any START_BLOCK or END_BLOCK tokens
        and use pop and top to determine scope and curly brace balance.
    */
    std::stack<TokenType> scope_stack;
    while (true) {
        std::string token;
        ...
        if (token_type == TOKEN_TYPE_START) {
            ...
            // Push the START_BLOCK to the scope stack
            ...
            // If the scope stack is empty, we are unbalanced and need to break
            else {
                // Error.
                break;
            }
